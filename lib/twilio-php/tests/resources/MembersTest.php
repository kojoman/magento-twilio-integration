...
class MembersTest extends PHPUnit_Framework_TestCase
{
    ...
    function testDequeueFront()
    {
        ...
        $http->shouldReceive('post')->once()
            ->with(
                '/2010-04-01/Accounts/AC123/Queues/QQ123/Members/Front.json',
    ...
    function testDequeueSid()
    {
        ...
        $http->shouldReceive('post')->once()
            ->with(
                '/2010-04-01/Accounts/AC123/Queues/QQ123/Members/CA123.json',
    ...
    function testMemberIterate()
    {
        ...
        $http->shouldReceive('get')->once()
            ...
            ->andReturn(
                array(200, array('Content-Type' => 'application/json'), $resp
                )
            );
        $http->shouldReceive('get')->once()
