...
class TwilioTest extends PHPUnit_Framework_TestCase
{
    ...
    protected $nginxError
        = array(500, array('Content-Type' => 'text/html'),
    ...
    function createMockHttp(
        $url, $method, $response, $params = null,
        $status = 200
    ) {
    ...
    {
        $this->assertSame(
            $end_string, Services_Twilio::getRequestUri(
    ...
    {
        $http = $this->createMockHttp(
            '/Calls/CA123/Notifications/NO123', 'get',
    ...
    function testArrayAccessForListResources()
    {
        ...
        $http->shouldReceive('get')->once()
            ...
            ->andReturn(
                array(400, array('Content-Type' => 'application/json'),
    ...
    function testRetryIdempotentFunctionsOnly()
    {
        ...
        $http->shouldReceive('post')->once()
            ->with(
                '/2010-04-01/Accounts/AC123/SMS/Messages.json', $this->formHeaders,
    ...
    {
        $http = $this->createMockHttp(
            '/Queues/QU123/Members/Front', 'post',
    ...
    function testPostMultivaluedForm()
    {
        ...
        $http->shouldReceive('post')->once()
            ->with(
                '/2010-04-01/Accounts/AC123/Messages.json', $this->formHeaders,
